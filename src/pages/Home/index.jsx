                        ...
                        <div>
                                ...
                                <div style={{display: "flex", gap: 15, alignItems: "center"}}>
                                    <Tooltip placement="topLeft" title={"Play all now"}>
                                        <Button
                                            ...
                                            onClick={() => dispatch(playListSongNow(listTopSongToday))}
                                        >
                                            <IoMdPlay style={{fontSize: 20}}/>
                                        </Button>
                                    </Tooltip>
                                    <Tooltip placement="topRight" title={"Add to queue"}>
                                        <Button
                                            ...
                                            onClick={() => dispatch(addSongList(listTopSongToday))}
                                        >
                                            <PiQueueFill style={{fontSize: 20}}/>
                                        </Button>
                                    </Tooltip>
                            ...
                            >
                                {listTopSongToday.map((itemSong, indexSong) => <CardSongOfHomepage
                                    key={indexSong} itemSong={itemSong} rank={indexSong + 1}/>)}
                            </Carousel>
                        </div>
                    }
                    <div>
                            ...
                            <div style={{display: "flex", gap: 15, alignItems: "center"}}>
                                ...
                                <Tooltip placement="topRight" title={"Add to queue"}>
                                    <Button
                                        ...
                                        onClick={() => dispatch(addSongList(listTopSongThisWeek))}
                                    >
                                        <PiQueueFill style={{fontSize: 20}}/>
                                    </Button>
                                </Tooltip>
                                <Tooltip placement="topLeft" title={"Play all now"}>
                                    <Button
                                        ...
                                        onClick={() => dispatch(playListSongNow(listTopSongThisWeek))}
                                    >
                                        <IoMdPlay style={{fontSize: 20}}/>
                                    </Button>
                                </Tooltip>
                            ...
                            <div style={{display: "flex", gap: 15, alignItems: "center"}}>
                                ...
                                <Tooltip placement="topRight" title={"Add to queue"}>
                                    <Button
                                        ...
                                        onClick={() => dispatch(addSongList(listTopSongThisMonth))}
                                    >
                                        <PiQueueFill style={{fontSize: 20}}/>
                                    </Button>
                                </Tooltip>
                                <Tooltip placement="topLeft" title={"Play all now"}>
                                    <Button
                                        ...
                                        onClick={() => dispatch(playListSongNow(listTopSongThisMonth))}
                                    >
                                        <IoMdPlay style={{fontSize: 20}}/>
                                    </Button>
                                </Tooltip>
