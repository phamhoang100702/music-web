        ...
        <>
            ...
            <Row justify={"center"}>
                ...
                >
                    <Row gutter={[15, 0]}>
                        <Col span={8}>
                            <Statistic title="Follower" value={follower.content ? follower.content : 0}/>
                        </Col>
                        <Col span={8}>
                        ...
                        <Col span={24}>
                            ...
                            >
                                <a
                                    ...
                                    href={`mailto:${singerProfile.username && singerProfile.username}`}
                    ...
                    Mail - {"email@example.com"}
                                ...
                                <a
                                    ...
                                    style={{display: "flex", alignItems: "center", gap: 8}}
                                    target="_blank"
                                    href={singerProfile.social_link && singerProfile.social_link} rel="noreferrer"
                                >
                                    <FaLink fontSize={28}/>{" "}
                                    <span style={{fontSize: 20}}>
                    Social link - {singerProfile.social_link && singerProfile.social_link}
                  </span>
                                </a>
                                <a
                                    className="singer-profile-link"
